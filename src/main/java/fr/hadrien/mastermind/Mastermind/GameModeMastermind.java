...
/**
 * Classe qui crée et gère les différents modes de jeu du Mastermind
 * @author hadrien
 * @since 15/10/2018
 */
public class GameModeMastermind {
     ...
     * @param numberUse
     */
    public GameModeMastermind(int solutionLength, int maxTry, boolean dev, int numberUse) {
